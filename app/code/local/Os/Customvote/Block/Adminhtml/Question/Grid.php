...
class Os_Customvote_Block_Adminhtml_Question_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('customvoteGrid');
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('title', array(
			'header'    => Mage::helper('customvote')->__('Item Content'),
			'width'     => '150px',
			'index'     => 'title',
      ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('customvote');
